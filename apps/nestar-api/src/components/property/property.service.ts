...
import { lookupAuthMemberLiked, lookupMember, shapeIntoMongoObjId } from '../../libs/config';
...
export class PropertyService {
	...
	public async likeTargetProperty(memebrId: ObjectId, likeRefId: ObjectId): Promise<Property> {
		console.log(memebrId, likeRefId);
	...
	public async removePropertyByAdmin(proprtyId: ObjectId): Promise<Property> {
		const search: T = { _id: proprtyId, propertyStatus: PropertyStatus.DELETE };
